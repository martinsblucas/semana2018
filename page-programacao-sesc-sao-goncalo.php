<?php
/*
Template Name: Programação por dia - SESC São Gonçalo
*/
?>
<?php get_header(); ?>
<?php
...
<main class="container programacao">
	<section class="row">
      ...
      <p><strong>Endereço:</strong> Av. Pres. Kennedy, 755 - Estrela do Norte, São Gonçalo</p>
...
[42 min. 2015. RJ.]</a></p>
        ...
        Dir. Letícia Simões [94 min. 2018. RJ.]</a></p>
        <h6>Classificação livre</h6>
        <h3>16h</h3>
        <p><strong><a href="/2018/masterclass-com-juliana-antunes/">MaStErClaSS CirCuito SESC CoM Juliana antunES</a></strong></p>
        <a name="23"></a>
        <h2>SeXTA 23</h2>
        <h3>          14h</h3>
...
Dir. Victória Álvares e Quentin
          Delaroche<br />
        [75 min. 2018. PE.]</a><br />
          (Com a presença do realizador)</p>
        <h6>Classificação livre<br />
          <br />
        </h6>
