<?php
/*
Template Name: Programação por dia - SESC Tijuca
*/
?>
<?php get_header(); ?>
<?php
...
<main class="container programacao">
	<section class="row">
      ...
      <p><strong>Endereço:</strong> R. Barão de Mesquita, 539 - Andarai, Rio de Janeiro</p>
...
[113 min. 2018. MG.]</a></p>
        <h6>Classificação 12 anos</h6>
        <h3>15h</h3>
        <p><strong><a href="/2018/masterclass-com-irmaos-carvalho/">MaStErClaSS CirCuito 
          SESC CoM irMãoS 
          CarvalHo</a></strong></p>
        <h3>18h</h3>
